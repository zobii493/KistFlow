...
import '../../helpers/fade_slide_transition.dart';
import '../../viewmodels/dashboard_vm.dart';
import '../../viewmodels/user_profile_vm.dart';
import '../../widgets/dashboard_charts_widgets/bar_chart.dart';
import '../../widgets/dashboard_charts_widgets/line_chart.dart';
import '../../widgets/dashboard_charts_widgets/pie_chart.dart';
        ...
        children: [
          ...
          Column(
            ...
            children: [
              Text(
                card['title'],
                style: TextStyle(color: AppColors.darkGreyOf(context),fontSize: 16,fontWeight: .w600),
              ),
              SizedBox(height: 4),
              Text(
                card['value'],
