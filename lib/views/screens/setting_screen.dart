...
import '../../widgets/setting_widgets/logout.dart';
    ...
    return Container(
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [
            AppColors.slateGrayOf(context).withOpacity(0.7),
            AppColors.slateGrayOf(context).withOpacity(0.9),
          ],
        ),
        borderRadius: BorderRadius.circular(20),
        boxShadow: [
          BoxShadow(
            color: AppColors.slateGrayOf(context).withOpacity(0.3),
            blurRadius: 20,
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: AppColors.offWhiteOf(context).withOpacity(0.1),
                    blurRadius: 10,
      ...
      child: Column(
        children: [
          _buildSettingTile(
            ...
            iconColor: const Color(0xFF6B7FFF).withOpacity(0.7),
            iconBgColor: const Color(0xFF6B7FFF).withOpacity(0.1),
            title: 'Help & Support',
          ...
          _buildSettingTile(
            ...
            iconColor: const Color(0xFF8B5CF6).withOpacity(0.7),
          ...
          _buildSettingTile(
            ...
            iconColor: AppColors.primaryTeal.withOpacity(0.7),
            iconBgColor: AppColors.primaryTeal.withOpacity(0.1),
          ...
          _buildSettingTile(
            ...
            iconColor: AppColors.warmAmber.withOpacity(0.7),
            iconBgColor: AppColors.warmAmber.withOpacity(0.1),
            title: 'App Version',
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        fontSize: 13,
                        color: AppColors.darkGreyOf(context).withOpacity(0.7),
                      ),
                    ),
                  ],
                ),
