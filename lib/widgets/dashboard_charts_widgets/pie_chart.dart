                    ...
                    child: PieChart(
                      PieChartData(
                        ...
                        sections: nonZeroData.map((i) {
                          final colors = [
                            AppColors.primaryTeal.withOpacity(0.8), // Paid
                            AppColors.warmAmber.withOpacity(0.8),   // Unpaid
                            Colors.redAccent.withOpacity(0.8),       // Overdue
                            Colors.blueAccent.withOpacity(0.8),      // Upcoming
                            Colors.greenAccent.withOpacity(0.8),     // Completed
                          ];
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (state.pieData[1] > 0)
                        _buildLegend(
                          AppColors.warmAmber.withOpacity(0.8),
                          'Unpaid',
                          state.pieData[1],
                        ),
